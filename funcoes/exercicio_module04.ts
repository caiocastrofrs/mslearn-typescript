...
interface BuildArray {
  (items: number, sortOrder: string): number[];
}

let buildArray: BuildArray = (items, sortOrder) => {
...
const loanCalculator: LoanType = (principle, interestRate, months) => {
